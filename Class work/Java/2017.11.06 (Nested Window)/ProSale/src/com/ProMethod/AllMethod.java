...
public class AllMethod {
    ...
    public boolean saveSales(ProSale p){
       DoConnetion dc=new DoConnetion();
        boolean ret=false;
    ...
    public boolean doUpdate(Product p) {
        ...
        con = dc.doCon();
        try {
            pstm = con.prepareStatement("UPDATE product01 SET name=?, price=?, stock=?, origin=?  WHERE id=?");
    ...
    public boolean doUpStock(Product p) {
        ...
        con = dc.doCon();
        try {
            pstm = con.prepareStatement("UPDATE product01 SET  stock=? WHERE id=?");
    ...
    public Product findProduct(int id){
        ...
        try {
            pstm = con.prepareStatement("SELECT * FROM product01 WHERE id=?");
            pstm.setInt(1, id);
