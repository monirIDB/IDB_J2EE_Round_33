 ...
 * @author APCL
 */
public class WinOpen extends javax.swing.JFrame {

    /**
     * Creates new form WinOpen
     */
    public WinOpen() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinOpen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
