 ...
 * @author APCL
 */
public class BookEntery extends javax.swing.JFrame {

    /**
     * Creates new form BookEntery
     */
    public BookEntery() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookEntery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookEntery().setVisible(true);
            }
        });
    }
